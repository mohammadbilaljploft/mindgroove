      ...
      <Container>
        <div className="header_inner">
          <div className="left_navbar">
            ...
            {/* ✅ Add 'active' class when any dropdown is open */}
            <div
            ...
            >
              ...
              <div className="switch_ask_anything">
                ...
                <div
                  className={`promp_list ${
                    activeSection === "ask" ? "active" : ""
                  }`}
                >
                  <div className="promp_list_item">
                    ...
                    <div className="promp_list_text">
                      ...
                      <p>
                        Music for a sixties heist movie, breathtaking
                        underwater exploration, wild west saloon brawl,
